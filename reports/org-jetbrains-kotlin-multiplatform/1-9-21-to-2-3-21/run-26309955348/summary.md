...
- **Version change:** `1.9.21` → `2.3.21`
- **Risk:** **HIGH**
- **Recommendation:** Hold merge until impacted files are reviewed and targeted regression checks pass.
- **Static impact:** 29 files (15 direct / 14 transitive-or-expect-actual)
- **UI impact:** 12 screens
...
| `/tmp/output/phase1/before/shared/src/commonMain/kotlin/com/github/jetbrains/rssreader/core/RssReader.kt` | direct | commonMain | 40 | 4 |
| `/tmp/output/phase1/before/shared/src/commonMain/kotlin/com/github/jetbrains/rssreader/core/entity/feed.kt` | direct | commonMain | 34 | 4 |
| `/tmp/output/phase1/before/composeApp/src/commonMain/kotlin/com/github/jetbrains/rssreader/compose/PostList.kt` | direct | commonMain | 105 | 3 |
